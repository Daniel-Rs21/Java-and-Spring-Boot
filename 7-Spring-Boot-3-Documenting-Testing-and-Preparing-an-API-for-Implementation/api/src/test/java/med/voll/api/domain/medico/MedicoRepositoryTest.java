...
public class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("deberia retornar nulo cuando realice la consulta en la base de datos en ese horario")
    void testSeleccionarMedicoAdecuadoRetornaNulo() {
        ...
        var medicoLibre = medicoRepository.seleccionarMedicoAdecuado(Especialidad.CARDIOLOGIA, proximoLunes10H);
    ...
    void testSeleccionarMedicoAdecuadoRetornaMedico() {
        var proximoLunes10H = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
