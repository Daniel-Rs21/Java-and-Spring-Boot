...
public class PruebaDeParametros {
    public static void main(String[] args) {
        ...
        List<Producto> resultado = productoDao.buscarPorParametro("FIFA", new BigDecimal(10000), null);

        System.out.println(resultado.get(0).getDescripcion());

        resultado = productoDao.buscarPorParametroApiCriteria("X", new BigDecimal(10000), null);
